...
@section('content')
<h2 style="color: #1e40af; margin-bottom: 1.5rem; font-weight: 700;">Crear Programa</h2>
...
<form action="{{ route('programas.store') }}" method="POST" style="background-color: #f9fafb; padding: 2rem; border-radius: 10px; max-width: 600px; box-shadow: 0 4px 8px rgba(0,0,0,0.05);">
    @csrf

    {{-- Código --}}
    <div style="margin-bottom: 1.5rem;">
        <label for="codigo" style="display: block; font-weight: 700; margin-bottom: 0.5rem; color: #374151;">Código del Programa</label>
        <input
            type="text"
            name="codigo"
            id="codigo"
        ...
        >
        <small id="codigoHelp" style="color: #6b7280;">Ejemplo: PROG-001</small>
    </div>

    {{-- Nombre --}}
    <div style="margin-bottom: 1.5rem;">
        <label for="nombre" style="display: block; font-weight: 700; margin-bottom: 0.5rem; color: #374151;">Nombre del Programa</label>
        <input
            type="text"
            name="nombre"
            id="nombre"
    ...
    {{-- Descripción --}}
    <div style="margin-bottom: 1.5rem;">
        <label for="descripcion" style="display: block; font-weight: 700; margin-bottom: 0.5rem; color: #374151;">Descripción del Programa</label>
        <textarea
            name="descripcion"
            id="descripcion"
            rows="4"
    ...
    <button
        ...
        aria-label="Guardar nuevo programa"
    >
        💾 Guardar Programa
    </button>
</form>
